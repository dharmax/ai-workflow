...
import { addManualNote, withWorkflowStore } from "../../../core/services/sync.ts";
import { routeTask } from "../../../core/services/router.ts";
import { generateCompletion } from "../../../core/services/providers.ts";
import { listToolkitCodelets } from "../../../core/services/codelets.ts";
...
async function renderHelp() {
  ...
  return [
    ...
    ...codelets
      .filter((codelet) => codelet.runner === "node-script" && codelet.entry?.includes("smart-codelet-runner.ts"))
