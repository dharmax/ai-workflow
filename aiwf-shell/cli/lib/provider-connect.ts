/**
 * @file provider-connect.js
 * @brief Auto-generated header for provider-connect.js. Needs detailed responsibility and scope.
 */

import * as readline from "node:readline/promises";
import { stdin as input, stdout as output } from "node:process";
import { getGlobalConfigPath, writeConfigValue } from "./config-store.ts";
