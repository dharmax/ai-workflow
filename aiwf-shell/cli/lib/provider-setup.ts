/**
 * @file provider-setup.js
 * @brief Auto-generated header for provider-setup.js. Needs detailed responsibility and scope.
 */

import * as readline from "node:readline/promises";
import { stdin as input, stdout as output } from "node:process";
import { getGlobalConfigPath, getProjectConfigPath, readConfigSafe, writeConfigValue } from "./config-store.ts";
