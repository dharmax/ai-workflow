/**
 * @file supergit.js
 * @brief Auto-generated header for supergit.js. Needs detailed responsibility and scope.
 */
...
async function runGit(args, { root = process.cwd() } = {}) {
  ...
  return result.ok
    ...
    : { ok: false, error: result.stderr || result.combined || "git command failed", stdout: result.stdout, stderr: result.stderr };
}
