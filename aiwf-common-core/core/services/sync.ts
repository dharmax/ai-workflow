...
function inferModuleResponsibility(moduleName, filePaths = []) {
  ...
  if (lower === "aiwf-common-core/core/services" || lower.startsWith("aiwf-common-core/core/services")) {
    return "Core workflow services for sync, orchestration, routing, status, and verification.";
  }
  if (lower === "aiwf-common-core/core/db" || lower.startsWith("aiwf-common-core/core/db")) {
    return "Workflow database persistence, schema management, and indexed state storage.";
  }
  if (lower === "aiwf-common-core/core/lib" || lower.startsWith("aiwf-common-core/core/lib")) {
    return "Shared workflow runtime helpers used across the CLI and core services.";
  }
  if (lower === "aiwf-common-core/core/parsers" || lower.startsWith("aiwf-common-core/core/parsers")) {
