/**
 * @file projections.js
 * @brief Auto-generated header for projections.js. Needs detailed responsibility and scope.
 */
...
import { getShellRoot, getToolkitRoot } from "../lib/toolkit-root.ts";

const toolkitRoot = getToolkitRoot();
const templatesRoot = path.resolve(getShellRoot(toolkitRoot), "templates");
