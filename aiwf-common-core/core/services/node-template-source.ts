/**
 * @file node-template-source.js
 * @brief Auto-generated header for node-template-source.js. Needs detailed responsibility and scope.
 */
...
export class NodeTemplateSource {
  async fetch(name) {
    ...
    // core/services/node-template-source.js -> ../../ is project root
