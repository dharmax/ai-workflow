/**
 * @file codelet-runtime.js
 * @brief Auto-generated header for codelet-runtime.js. Needs detailed responsibility and scope.
 */

import path from "node:path";
import { buildSurgicalContext, formatContextForPrompt } from "./context-packer.ts";
import { getCodelet, getProjectSummary, withWorkflowStore } from "./sync.ts";
