/**
 * @file operating-context.js
 * @brief Auto-generated header for operating-context.js. Needs detailed responsibility and scope.
 */
...
export { getToolkitRoot } from "./toolkit-root.ts";
