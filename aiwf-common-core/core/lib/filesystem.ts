/**
 * @file filesystem.js
 * @brief Auto-generated header for filesystem.js. Needs detailed responsibility and scope.
 */
...
import { getCommonCoreRoot } from "./toolkit-root.ts";
...
export async function loadPromptTemplate(templateName) {
  const templatePath = path.resolve(getCommonCoreRoot(), "shared", "prompts", `${templateName}.md`);
  try {
