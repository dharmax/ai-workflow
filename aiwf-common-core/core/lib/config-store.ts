/**
 * Responsibility: Shared config file helpers for project/global ai-workflow config.
 * Scope: Safe to import from both core and CLI without introducing a core -> cli dependency.
 */
