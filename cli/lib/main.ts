...
import { buildTicketEntity, importLegacyProjections, inferTicketLane, renderEpicsProjection, renderKanbanProjection, writeProjectProjections } from "../../core/services/projections.ts";
...
import { updateKnowledgeRemote } from "../../core/services/knowledge.ts";
import { assertSafeRepairTarget, getToolkitRoot as getOperatingToolkitRoot, resolveOperatingContext } from "../../core/lib/operating-context.ts";
import { readLatestRunArtifact } from "../../core/lib/run-artifacts.ts";
import { resolveHostRequest } from "../../core/services/operator-brain.ts";
import { discoverProviderState, refreshProviderRegistry } from "../../core/services/providers.ts";
import { invalidateModelFitCache } from "../../core/services/model-fit.ts";
import { invalidateWebSearchCache } from "../../core/services/web-search.ts";
...
import { STATUS_NODE_TYPES, formatStatusReport, resolveProjectStatus } from "../../core/services/status.ts";
